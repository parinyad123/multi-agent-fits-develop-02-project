"""initial schema with uuid session_id

Revision ID: c5cf9b8dcb19
Revises: 
Create Date: 2025-11-21 23:35:03.029150
...
def upgrade() -> None:
    ...
    op.create_index('idx_fits_is_deleted', 'fits_files', ['is_deleted'], unique=False)
...
def downgrade() -> None:
    ...
    op.drop_index('idx_fits_is_deleted', table_name='fits_files')
